/**
 * Seed script: creates the admin account, demo distributors/buyers,
 * categories and products so the platform is usable immediately.
 *
...
async function main() {
  ...
  console.log("Distributors: tashkent-foods / dist123, milkline / dist123");
  console.log("Buyers:       magazin-baraka / buyer123, cafe-sharq / buyer123");
  void admin;
}
