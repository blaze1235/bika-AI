...
class Event(Base):
    ...
    person_track_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    review: Mapped[Optional["EventReview"]] = relationship(
        "EventReview", back_populates="event", uselist=False
    )
...
class Zone(Base):
    ...
    # normalized 0-1 rectangle coordinates
